...
from Emoserver.utils.load_user_define import user_defined_mixin

if USING_SOCIAL_LOGIN:
    from Emoserver.socialoauth import SocialSites, SocialAPIError, SocialSitesConfigError
...
class SiteUserResetPwStepOneView(user_defined_mixin(), SiteUserMixIn, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        msg = EmailMultiAlternatives(self.reset_passwd_email_title,"", EMAIL_HOST_USER, [email])
